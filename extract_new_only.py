#!/usr/bin/env python3
"""
Extract only new conversations from an export file.
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python extract_new_only.py <input_file> [output_file]")
        sys.exit(1)
    ...
    print(f"\nNext step:")
    print(f"  python cogrepo_import.py --source chatgpt --file {output_file} --enrich")
